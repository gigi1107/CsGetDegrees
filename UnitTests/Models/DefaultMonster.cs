...
namespace UnitTests.Models.Default
{
    public static partial class DefaultModels
    {
        ...
        public static Monster MonsterDefault()
        {
            ...
            myData.MonsterAttribute.Speed = 1;
            myData.MonsterAttribute.Defense = 1;
            myData.MonsterAttribute.Attack = 1;
            myData.MonsterAttribute.CurrentHealth = 1;
            myData.MonsterAttribute.MaxHealth = 1;
